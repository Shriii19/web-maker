      ...
      <footer class="footer">
        <div class="footer-content">
          <div class="footer-section">
            <h3 class="footer-title">SM Studio</h3>
            <div class="footer-info">
              <p class="footer-location">Pune, Maharashtra</p>
              <p class="footer-phone">+91 9579579999</p>
              <a href="mailto:mudabeshrinivas@gmail.com" class="footer-email">mudabeshrinivas@gmail.com</a>
            </div>
          </div>
          ...
          <div class="footer-section">
            ...
            <div class="footer-links">
              ...
              <a href="templates.html" class="footer-link">🎨 Projects</a>
              <a href="features.html" class="footer-link">🏆 Achievements</a>
              <a href="pricing.html" class="footer-link">📄 Resume</a>
          ...
          <div class="footer-section">
            ...
            <div class="footer-social">
              ...
              <a href="https://discord.com" target="_blank" class="social-link" aria-label="Discord">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="mailto:mudabeshrinivas@gmail.com" class="social-link" aria-label="Email">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                </svg>
              </a>
        ...
        <div class="footer-bottom">
          <div class="footer-container">
            ...
            <p class="footer-credit">A project by ❤️ Shrinivas Mudabe.</p>
          </div>
        </div>
      </footer>
    `;
